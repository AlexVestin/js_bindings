...
class NavigationCurrentEntryChangeEvent implements Event {
  external NavigationCurrentEntryChangeEvent(
...
class NavigateEvent implements Event {
  external NavigateEvent(String type, NavigateEventInit eventInit);
}
...
class NavigationDestination {
  external NavigationDestination();
}
